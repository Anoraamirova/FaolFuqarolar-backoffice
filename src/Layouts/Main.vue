  ...
  <div>
    <v-app v-show="true" id="inspire">
      ...
      >
        <v-list>
          <template v-for="item in items">
            ...
            >
              <v-list-item-action>
                <v-icon color="#424242">{{ item.icon }}</v-icon>
              </v-list-item-action>
              <v-list-item-content>
                <v-list-item-title>
                  {{ $t(item.text) }}
      ...
      <v-navigation-drawer
        ...
        right
      >
        <template v-slot:prepend color="grey lighten-2">
          <v-list-item two-line color="grey lighten-2">
            <v-list-item-avatar>
...
export default {
  ...
  data: () => ({
    ...
    items: [
      ...
      { icon: 'mdi-wrench', path: '/sozlamalar', text: 'Sozlamalar', id: 3 },
      {
